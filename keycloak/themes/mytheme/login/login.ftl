...
<@layout.registrationLayout bodyClass="none" displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    <#if section = "header">
		<h1>CITELIBRE</h1>
                ...
                <div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
                  ...
                  <div id="kc-form-buttons" class="${properties.kcFormGroupClass!}">
                      ...
                      <div class="${properties.kcFormOptionsClass!}">
                        <div class="${properties.kcFormOptionsWrapperClass!}">
                            <span><a href="${properties.kcBackLink}"><i class="fa fa-angle-double-left" aria-hidden="true"></i> ${msg("doCancel")}</a></span>
                        </div>
                    </div>
                    <br>
                  </div>
